...
DROP TYPE IF EXISTS public.play_mode CASCADE;
...
DROP POLICY IF EXISTS "dev read" ON public.developers;
CREATE POLICY "dev read" ON public.developers FOR SELECT USING (true);
DROP POLICY IF EXISTS "dev admin write" ON public.developers;
...
CREATE INDEX IF NOT EXISTS idx_products_kind ON public.products(kind) WHERE published;
CREATE INDEX IF NOT EXISTS idx_products_featured ON public.products(featured) WHERE published;
...
DROP POLICY IF EXISTS "ptag read" ON public.product_tags;
CREATE POLICY "ptag read" ON public.product_tags FOR SELECT USING (true);
DROP POLICY IF EXISTS "ptag admin" ON public.product_tags;
...
DROP POLICY IF EXISTS "ss read" ON public.screenshots;
CREATE POLICY "ss read" ON public.screenshots FOR SELECT USING (true);
DROP POLICY IF EXISTS "ss admin" ON public.screenshots;
...
DROP POLICY IF EXISTS "ver read" ON public.versions;
CREATE POLICY "ver read" ON public.versions FOR SELECT USING (true);
DROP POLICY IF EXISTS "ver admin" ON public.versions;
...
DROP POLICY IF EXISTS "dl read" ON public.downloads;
CREATE POLICY "dl read" ON public.downloads FOR SELECT USING (true);
DROP POLICY IF EXISTS "dl admin" ON public.downloads;
...
DROP POLICY IF EXISTS "fav self all" ON public.favorites;
...
DROP POLICY IF EXISTS "req read self or admin" ON public.requests;
...
DROP POLICY IF EXISTS "req insert self" ON public.requests;
CREATE POLICY "req insert self" ON public.requests FOR INSERT TO authenticated WITH CHECK (auth.uid() = user_id);
DROP POLICY IF EXISTS "req admin update" ON public.requests;
...
DROP POLICY IF EXISTS "news admin" ON public.news;
...
DROP POLICY IF EXISTS "set admin" ON public.settings;
...
DROP POLICY IF EXISTS "Users view own preorders" ON public.preorders;
CREATE POLICY "Users view own preorders" ON public.preorders
  FOR SELECT TO authenticated USING (auth.uid() = user_id);
DROP POLICY IF EXISTS "Admins view all preorders" ON public.preorders;
CREATE POLICY "Admins view all preorders" ON public.preorders
  FOR SELECT TO authenticated USING (public.has_role(auth.uid(), 'admin'));
DROP POLICY IF EXISTS "Users create own preorders" ON public.preorders;
CREATE POLICY "Users create own preorders" ON public.preorders
  FOR INSERT TO authenticated WITH CHECK (auth.uid() = user_id);
DROP POLICY IF EXISTS "Users delete own preorders" ON public.preorders;
...
DROP POLICY IF EXISTS "community settings admin" ON public.community_settings;
...
DROP POLICY IF EXISTS "community categories admin" ON public.community_categories;
